...
import { Users, DollarSign, Calendar, Award, ShieldAlert } from "lucide-react";
import {
...
interface AdminOverviewProps {
  reportData: {
    growthTrend: { month: string; members: number }[];
    revenueTrend: { month: string; revenue: number }[];
    eventPopularity: { name: string; registered: number; capacity: number }[];
    distributions: { basic: number; premium: number; elite: number };
    metrics: {
      totalMembers: number;
